...
export default function About() {
    ...
    <div className="min-h-screen bg-[#333] text-white flex flex-col items-center pt-32 p-8 sm:p-24 sm:pt-24 pb-32 gap-16">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-12 items-center fade-in-slide">
        <div>
          ...
          <p className="mt-4 text-lg">
            ...
            That’s why we craft the fluffiest, chewiest mochi donuts and 
            pair them with the most slurpable boba tea in existence. Whether 
            you’re here for a quick treat or a full-on sugar pilgrimage, we’ve got your cravings covered.
          </p>
        </div>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-12 items-center fade-in-slide">
        ...
        <div>
          ...
          <p className="mt-4 text-lg">
            To spread joy, one gloriously chewy bite at a time. 
            We’re on a quest to make the world a better place with fried 
            dough and tapioca pearls—because happiness is just a donut and a boba away.
          </p>
        </div>
      </section>
  ...
  <h2 className="text-3xl font-semibold">Visit us and enjoy!</h2>
