...
const storeLocations = [
  {
    ...
    googleMapsUrl:
      "https://maps.google.com/?q=1021+Jim+Warren+Pkwy+Suite+220+Spring+Hill+TN+37174",
  },
];
    ...
    <div className="min-h-screen bg-[#333] text-white flex flex-col items-center py-24 px-4 sm:px-8 lg:px-16 gap-16">
      ...
      >
        <div className="mx-auto max-w-lg">
          <div className="bg-[#444] shadow-lg rounded-xl overflow-hidden transition-all duration-300 border-2 border-yellow-400">
